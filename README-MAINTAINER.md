...
- name the post like: **µOS++ devices-stm32f0-extras v2.0.0 released**
...
- `npm dist-tag add @micro-os-plus/devices-stm32f0-extras@2.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/devices-stm32f0-extras`
...
- paste the release name like **µOS++ devices-stm32f0-extras v2.0.0 released**
