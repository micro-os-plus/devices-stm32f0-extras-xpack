...
```sh
git clone https://github.com/micro-os-plus/devices-stm32f0-extras-xpack.git devices-stm32f0-extras-xpack.git
```
...
- name the post like: **µOS++ devices-stm32f0-extras v1.1.0 released**
...
- `npm dist-tag add @micro-os-plus/devices-stm32f0-extras@1.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/devices-stm32f0-extras`
...
- paste the release name like **µOS++ devices-stm32f0-extras v1.1.0 released**
