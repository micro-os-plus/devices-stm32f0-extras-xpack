[![license](https://img.shields.io/github/license/micro-os-plus/devices-stm32f0-extras-xpack)](https://github.com/micro-os-plus/devices-stm32f0-extras-xpack/blob/xpack/LICENSE)
...
```sh
git clone --recurse-submodules https://github.com/micro-os-plus/devices-stm32f0-extras-xpack.git devices-stm32f0-extras-xpack.git
```
...
- name the post like: **µOS++ devices-stm32f0-extras v2.0.1 released**
- update the `date:` field with the current date
- update the GitHub Actions URLs using the actual test pages

If any, refer to closed
[issues](https://github.com/micro-os-plus/devices-stm32f0-extras/issues)
as:
...
- `npm dist-tag add @micro-os-plus/devices-stm32f0-extras@2.0.1 latest`
- `npm dist-tag ls @@micro-os-plus/devices-stm32f0-extras`
...
- paste the release name like **µOS++ devices-stm32f0-extras v2.0.1 released**
